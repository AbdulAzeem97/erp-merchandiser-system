...
const ROLE_HIERARCHY = {
  ADMIN: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'HEAD_OF_PRODUCTION', 'HOD_PREPRESS', 'DESIGNER', 'MERCHANDISER'],
  HEAD_OF_MERCHANDISER: ['HEAD_OF_MERCHANDISER', 'MERCHANDISER'],
  HEAD_OF_PRODUCTION: ['HEAD_OF_PRODUCTION', 'HOD_PREPRESS', 'DESIGNER'],
...
const PERMISSIONS = {
  ...
  VIEW_PREPRESS_JOBS: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'HEAD_OF_PRODUCTION', 'HOD_PREPRESS', 'DESIGNER'],
