...
const ROLE_HIERARCHY = {
  ADMIN: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'HEAD_OF_PRODUCTION', 'HOD_PREPRESS', 'HOD_CUTTING', 'HOD_PRODUCTION', 'HOD_OFFSET', 'DESIGNER', 'MERCHANDISER', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER', 'QA', 'QA_PREPRESS', 'INVENTORY_MANAGER', 'PROCUREMENT_MANAGER', 'CUTTING_LABOR', 'PRODUCTION_OPERATOR', 'OFFSET_OPERATOR'],
  HEAD_OF_MERCHANDISER: ['HEAD_OF_MERCHANDISER', 'MERCHANDISER', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER'],
  DIRECTOR: ['DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER', 'MERCHANDISER'],
  SENIOR_MERCHANDISER: ['SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER', 'MERCHANDISER'],
  ASSISTANT_MERCHANDISER: ['ASSISTANT_MERCHANDISER', 'MERCHANDISER'],
  HEAD_OF_PRODUCTION: ['HEAD_OF_PRODUCTION', 'HOD_PREPRESS', 'HOD_CUTTING', 'HOD_PRODUCTION', 'HOD_OFFSET', 'DESIGNER', 'QA', 'QA_PREPRESS', 'CUTTING_LABOR', 'PRODUCTION_OPERATOR', 'OFFSET_OPERATOR'],
  HOD_PREPRESS: ['HOD_PREPRESS', 'DESIGNER'],
  HOD_CUTTING: ['HOD_CUTTING', 'CUTTING_LABOR'],
  HOD_PRODUCTION: ['HOD_PRODUCTION', 'PRODUCTION_OPERATOR'],
  HOD_OFFSET: ['HOD_OFFSET', 'OFFSET_OPERATOR'],
  DESIGNER: ['DESIGNER'],
  ...
  OFFSET_OPERATOR: ['OFFSET_OPERATOR']
};

const PERMISSIONS = {
  // Dashboard permissions
  VIEW_DASHBOARD: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'HEAD_OF_PRODUCTION', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER'],
  VIEW_HOM_DASHBOARD: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'DIRECTOR', 'SENIOR_MERCHANDISER'],
  ...
  CREATE_PREPRESS_JOBS: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'HOD_PREPRESS', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER'],
  ...
  VIEW_JOB_CARDS: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'HEAD_OF_PRODUCTION', 'HOD_PREPRESS', 'DESIGNER', 'MERCHANDISER', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER'],
  CREATE_JOB_CARDS: ['ADMIN', 'MERCHANDISER', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER'],
  UPDATE_JOB_CARDS: ['ADMIN', 'MERCHANDISER', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER'],
  UPDATE_JOB_PO_NUMBER: ['ADMIN', 'MERCHANDISER', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER'],
  DELETE_JOB_CARDS: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'DIRECTOR'],
  
  // Product permissions
  VIEW_PRODUCTS: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'HEAD_OF_PRODUCTION', 'HOD_PREPRESS', 'DESIGNER', 'MERCHANDISER', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER'],
  CREATE_PRODUCTS: ['ADMIN', 'MERCHANDISER', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER'],
  UPDATE_PRODUCTS: ['ADMIN', 'MERCHANDISER', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER'],
  DELETE_PRODUCTS: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'DIRECTOR'],
  
  // Company permissions
  VIEW_COMPANIES: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'HEAD_OF_PRODUCTION', 'HOD_PREPRESS', 'DESIGNER', 'MERCHANDISER', 'DIRECTOR', 'SENIOR_MERCHANDISER', 'ASSISTANT_MERCHANDISER'],
  CREATE_COMPANIES: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'DIRECTOR'],
  UPDATE_COMPANIES: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'DIRECTOR'],
  DELETE_COMPANIES: ['ADMIN', 'HEAD_OF_MERCHANDISER', 'DIRECTOR'],
  ...
  // Offset Printing permissions
  VIEW_OFFSET_PRINTING_JOBS: ['ADMIN', 'HEAD_OF_PRODUCTION', 'HOD_OFFSET', 'OFFSET_OPERATOR'],
  ASSIGN_OFFSET_PRINTING_JOBS: ['ADMIN', 'HOD_OFFSET'],
  UPDATE_OFFSET_PRINTING_STATUS: ['ADMIN', 'HOD_OFFSET', 'OFFSET_OPERATOR'],
  COMPLETE_OFFSET_PRINTING_JOBS: ['ADMIN', 'HOD_OFFSET', 'OFFSET_OPERATOR'],
  REJECT_OFFSET_PRINTING_JOBS: ['ADMIN', 'HOD_OFFSET']
};
