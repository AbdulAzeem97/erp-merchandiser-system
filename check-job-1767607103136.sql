...
SELECT 
  ...
  "updatedAt"
FROM job_cards
WHERE "jobNumber" = 'JC-1767607103136';
...
WHERE job_card_id = (SELECT id FROM job_cards WHERE "jobNumber" = 'JC-1767607103136')
...
WHERE job_id = (SELECT id FROM job_cards WHERE "jobNumber" = 'JC-1767607103136');
...
WHERE jc."jobNumber" = 'JC-1767607103136'
